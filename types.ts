...
export type GameState = 'MENU' | 'HUB' | 'DAY' | 'NIGHT' | 'LEVEL1' | 'LEVEL2' | 'LEVEL3' | 'LEVEL4' | 'LEVEL5' | 'LEVEL6' | 'LEVEL7' | 'LEVEL8' | 'JUMPSCARE' | 'ENDING' | 'PRAYER' | 'ATATURK' | 'CUSTOM_NIGHT' | 'MOD_SHOP' | 'NEW_OFFICE' | 'CUSTOM_NIGHT_SETUP' | 'UNDERGROUND' | 'MOD_ROOM' | 'PIPE_MONSTER_GAME' | 'AI_LOUNGE' | 'LOADING';
